...
public class LaunchDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String mLaunchId = (String) getIntent().getSerializableExtra("LaunchId");
        LaunchViewModel launchViewModel =
                new ViewModelProvider(this).get(LaunchViewModel.class);
        launchViewModel.getLiveData().observe(this, launchList -> {

            Launch mLaunch = launchList.get(0);
            ...
            mName.setText(mLaunch.getRocket().getConfiguration().getName().equals("") ? "--" : mLaunch.getRocket().getConfiguration().getName());
            ...
            mAgency = mLaunch.getLaunchServiceProvider();
        ...
        launchViewModel.getLaunchById(mLaunchId);
